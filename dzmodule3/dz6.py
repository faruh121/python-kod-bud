...
# Реализовать прототип игры платформер с использованием движка для продвинутой физики.

# В игре персонаж прыгает по платформам и собирает монеты. При столкновении с вражеским объектом, игра останавливается.
